...
function(mitkFunctionGetLibrarySearchPaths search_path intermediate_dir)
  ...
  if(ITK_DIR)
    if(ITK_RUNTIME_LIBRARY_DIRS)
      list(APPEND _dir_candidates ${ITK_RUNTIME_LIBRARY_DIRS})
    endif()
  endif()
  if(DCMTK_DIR)
  ...
  if(ANN_DIR)
    if (ANN_RUNTIME_LIBRARY_DIRS)
        list(APPEND _dir_candidates "${ANN_RUNTIME_LIBRARY_DIRS}")
    else()
